  ...
  return (
    <div className="app-container login-page">
      ...
      <div className="login-card animate-fade-in">
        ...
        {successMsg && (
          <div className="alert alert-success" style={{ marginBottom: "1.5rem", background: "#f0fdf4", color: "#166534", border: "1px solid #bbf7d0" }}>
            <CheckCircle size={16} />
        ...
        <div style={{ textAlign: "center", marginTop: "1.5rem" }}>
          <Link to="/login" style={{ color: "var(--primary-color, #2563eb)", fontSize: "0.875rem", textDecoration: "none" }}>
...
function ResetPasswordView() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrorMsg(err.message || "Ocurrió un error al restablecer tu contraseña.");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="app-container login-page">
      ...
      <div className="login-card animate-fade-in">
        ...
        {successMsg && (
          <div className="alert alert-success" style={{ marginBottom: "1.5rem", background: "#f0fdf4", color: "#166534", border: "1px solid #bbf7d0" }}>
            <CheckCircle size={16} />
            <span>{successMsg} Redirigiendo al inicio de sesión...</span>
          </div>
        )}
